...
::: incremental
3. What does `geom_smooth()` do in a plot, and how can you modify it to display separate lines for different groups in the data?  

    <br>

4. What is the difference between `facet_wrap()` and `facet_grid()`, and when would you use each?
...
::: incremental
5. What is a statistical transformation in ggplot2? Give an example of a geom that requires one and explain why.

    <br>


6. Explain the role of position adjustments in ggplot2. How do `"dodge"`, `"fill"`, and `"jitter"` affect the appearance of a plot?
