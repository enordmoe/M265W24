...
Here’s the revised version, formatted to match your long-form notes with **brief bullet points** and **Quarto callout boxes** where relevant. I’ve also **double-checked the variable names in `storms`** to correct errors.
