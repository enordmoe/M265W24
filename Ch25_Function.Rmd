...
```{r , output.lines = 10}
all_speeches_page <- read_html("https://www.gov.scot/collections/first-ministers-speeches/")
url_end <- all_speeches_page |>
  html_nodes(".collections-list a") |>
  html_attr("href") |>
  str_subset("covid-19")

  str_c("https://www.gov.scot", url_end)
```
...
```{r, output.lines = 10}
covid_speech_url_ends <- all_speeches_page |>
  html_nodes(".collections-list a") |>
  html_attr("href") |>
  str_subset("covid-19")

covid_speech_urls <- str_c("https://www.gov.scot", covid_speech_url_ends)
covid_speech_urls
```
...
## Next time we'll have the `purrr`fect solution! 
