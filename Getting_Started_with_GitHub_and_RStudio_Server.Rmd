...
-   Enter a Commit message such as "My first commit from RStudio." Then click on the button Commit to stage. Don't close this window yet.
...
Click the green "Push" arrow button in the upper right  to send your local changes to GitHub. If you are challenged for username and password, provide them but for your password, you should paste in the PAT created earlier. You should see some message along these lines.
